...
Thanks for your interest in contributing to Mac Media Stack (Advanced).

## How to Help

- **Bug reports**: Open an issue with your macOS version, Docker version, and the output of `bash scripts/health-check.sh`.
...
- Python scripts (like download-watchdog.py) should work with the system Python 3 that ships with macOS.
